...
For Vercel and Android deployment, see [DEPLOYMENT.md](DEPLOYMENT.md). The frontend now supports a configurable backend URL and API key, and the Android project is in `frontend/android/`.
